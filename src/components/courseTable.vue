<template>
    <div class="flex flex-col rounded-t-lg overflow-hidden">
        <secton class="grid grid-cols-8 mb-3 bg-amber-100">
            <span class="bg-amber-300 flex items-center justify-center"
                >7月</span
            >
            <span class="flex flex-col justify-center items-center">
                <p class="text-base">周日</p>
                <p class="text-sm">8</p>
            </span>

            <span class="flex flex-col justify-center items-center">
                <p class="text-base">周一</p>
                <p class="text-sm">9</p>
            </span>
            <span class="flex flex-col justify-center items-center">
                <p class="text-base">周二</p>
                <p class="text-sm">10</p>
            </span>
            <span class="flex flex-col justify-center items-center">
                <p class="text-base">周三</p>
                <p class="text-sm">11</p>
            </span>
            <span class="flex flex-col justify-center items-center">
                <p class="text-base">周四</p>
                <p class="text-sm">7/12</p>
            </span>
            <span class="flex flex-col justify-center items-center">
                <p class="text-base">周五</p>
                <p class="text-sm">13</p>
            </span>
            <span class="flex flex-col justify-center items-center">
                <p class="text-base">周六</p>
                <p class="text-sm">14</p>
            </span>
        </secton>

        <section
            class="grid grid-cols-8 gap-2 flex-grow"
        ...
        >
            ...
            <span
                class="bg-green-400 rounded-md p-1 hover:outline"
                :style="{ gridArea: '3/4/5/5' }"
                >语文</span
            >
            <span
                class="bg-green-400 rounded-md p-1 hover:outline"
                :style="{ gridArea: '5/3/8/4' }"
                >语文</span
            >
            <span
                class="bg-green-400 rounded-md p-1 hover:outline"
                :style="{ gridArea: '1/7/3/8' }"
                >语文</span
            >
            <span
                class="bg-green-400 rounded-md p-1 hover:outline"
                :style="{ gridArea: '4/7/6/8' }"
                >语文</span
            >
            <span
                class="bg-green-400 rounded-md p-1 hover:outline"
                :style="{ gridArea: '5/5/7/6' }"
                >语文</span
            >
            <span
                class="bg-green-400 rounded-md p-1 hover:outline"
